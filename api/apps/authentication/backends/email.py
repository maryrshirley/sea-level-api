...
class EmailBackend(NoPasswordBackend):
    ...
    def send_login_code(self, code, host=None, url=None,
        ...
        context = {'url': self.login_url(code, host, url),
                   'code': code}
        text_content = render_to_string('registration/login_email.txt',
                                        context)
        html_content = render_to_string('registration/login_email.html',
                                        context)
